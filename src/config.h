...
template <typename FromType, typename ToType> class LexicalCast
{
  public:
...
class ConfValBase
{
  ...
  public:
    ...
    ConfValBase(const std::string &name, const std::string &desc = "") : m_name(name), m_desc(desc)
    {
    }
    virtual ~ConfValBase()
    {
...
template <typename T> class ConfigVar : public ConfValBase
{
  private:
    T m_val;
  ...
  public:
    ...
    ConfigVar(const std::string &name, const T &def, const std::string &desc = "") : ConfValBase(name, desc), m_val(def)
    {
    }
    ~ConfigVar(){};
...
class Config
{
  public:
    ...
    template <typename T> static typename ConfigVar<T>::ptr Lookup(const std::string &name)
    {
