...
class FDEntity
{
  ...
  public:
    ...
    {
        return m_is_sys_nonblock;
    }
    bool is_user_nonblock() const
    {
        return m_is_user_nonblock;
    }
    ...
    TimerManager::Timer::ptr timer() const
    {
        return m_timer;
    }

    void set_sys_nonblock(bool flag)
    {
        m_is_sys_nonblock = flag;
    }
    void set_user_nonblock(bool flag)
    {
        m_is_user_nonblock = flag;
    }
    void set_connect_timeout(uint64_t t)
    {
        m_connect_timeout = t;
    }
    void set_recv_timeout(uint64_t t)
    {
        m_recv_timeout = t;
    }
    void set_send_timeout(uint64_t t)
    {
        m_send_timeout = t;
    }
    void set_timer(TimerManager::Timer::ptr timer)
    {
        m_timer = timer;
    }
