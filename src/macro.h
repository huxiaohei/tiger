...
#define TIGER_LOG_FMT_D(name, fmt, ...)                                                                                \
    TIGER_LOG_FMT_DEBUG(tiger::SingletonLoggerMgr::Instance()->get_logger_by(name), fmt, __VA_ARGS__)
#define TIGER_LOG_FMT_I(name, fmt, ...)                                                                                \
    TIGER_LOG_FMT_INFO(tiger::SingletonLoggerMgr::Instance()->get_logger_by(name), fmt, __VA_ARGS__)
#define TIGER_LOG_FMT_W(name, fmt, ...)                                                                                \
    TIGER_LOG_FMT_WARN(tiger::SingletonLoggerMgr::Instance()->get_logger_by(name), fmt, __VA_ARGS__)
#define TIGER_LOG_FMT_E(name, fmt, ...)                                                                                \
    TIGER_LOG_FMT_ERROR(tiger::SingletonLoggerMgr::Instance()->get_logger_by(name), fmt, __VA_ARGS__)
