...
template <class T>
bool CheckGetAs(const std::map<std::string, std::string, CaseInsensitiveLess> &m, const std::string &key, T &val,
                const T def = T())
{
    auto it = m.find(key);
    if (it == m.end())
...
class HTTPResponse
{
  ...
  public:
    ...
    void set_reason(const std::string &v)
    {
        m_reason = v;
    }

    const std::map<std::string, std::string, CaseInsensitiveLess> &get_headers()
    {
        return m_headers;
    }
    std::string get_header(const std::string &key, const std::string &v);
    void set_headers(const std::map<std::string, std::string, CaseInsensitiveLess> &v)
    {
        m_headers = v;
    }
    ...
    template <class T> bool check_get_header_as(const std::string &key, T &val, const T &def = T())
    {
        return CheckGetAs(m_headers, key, val, def);
    }

    template <class T> T get_header_as(const std::string &key, const T &def = T())
    {
    ...
    void set_cookies(const std::string &key, const std::string &val, time_t expired = 0, const std::string &path = "",
...
class HTTPRequest
{
  ...
  public:
    ...
    uint8_t get_parser_param_flag() const
    {
        return m_parser_param_flag;
    }
    void set_parser_param_flag(uint8_t v)
    {
        m_parser_param_flag = v;
    }
    ...
    void set_fragment(const std::string &v)
    {
        m_fragment = v;
    }
    ...
    const std::map<std::string, std::string, CaseInsensitiveLess> &get_headers() const
    {
        return m_headers;
    }
    std::string get_header(const std::string &key, const std::string &def = "") const;
    void set_headers(std::map<std::string, std::string, CaseInsensitiveLess> &v)
    {
        m_headers = v;
    }
    ...
    template <class T> bool check_get_header_as(const std::string &key, T &v, const T &def = T())
    {
    ...
    void set_params(std::map<std::string, std::string, CaseInsensitiveLess> &v)
    {
        m_params = v;
    }
    ...
    template <class T> bool check_get_param_as(const std::string &key, T &v, const T &def = T())
    {
        return CheckGetAs(m_params, key, v, def);
    }
    template <class T> T check_get_param_as(const std::string &key, const T &def = T())
    {
        return GetAs(m_params, key, def);
    }

    void set_cookies(std::map<std::string, std::string, CaseInsensitiveLess> &v)
    {
        m_cookies = v;
    }
    ...
    template <class T> bool check_get_cookie_as(const std::string &key, T &v, const T &def = T())
    {
        return CheckGetAs(m_cookies, key, v, def);
    }
    template <class T> T get_cookie_as(const std::string &key, const T &def = T())
    {
