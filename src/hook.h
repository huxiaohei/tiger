...
extern "C"
{
    ...
    typedef int (*connect_func)(int socket, const struct sockaddr *address, socklen_t address_len);
    extern connect_func connect_f;

    typedef int (*accept_func)(int socket, struct sockaddr *address, socklen_t *address_len);
    ...
    typedef ssize_t (*recvfrom_func)(int socket, void *buffer, size_t length, int flags, struct sockaddr *address,
    ...
    typedef ssize_t (*sendto_func)(int socket, const void *message, size_t length, int flags,
    ...
    typedef int (*getsockopt_func)(int socket, int level, int option_name, void *option_value, socklen_t *option_len);
    extern getsockopt_func getsockopt_f;

    typedef int (*setsockopt_func)(int socket, int level, int option_name, const void *option_value,
